...
public class UmaViewerUI : MonoBehaviour
{
    ...
    public static string GetCostumeName(string costumeId, string defaultname)
    {
        switch (costumeId)
        {
            ...
            case "90":
                return LocalizationManager.Get("costume.upgraded");
            case "0001_00_01":
                return LocalizationManager.Get("costume.race_shorts");
            case "0001_00_02":
                return LocalizationManager.Get("costume.race_bloomers");
            case "0002_00_00":
                return LocalizationManager.Get("costume.school_short_sleeves");
            case "0002_00_03":
                return LocalizationManager.Get("costume.school_short_sleeves_belly");
            case "0002_01_00":
                return LocalizationManager.Get("costume.school_long_sleeves");
            case "0002_01_03":
                return LocalizationManager.Get("costume.school_long_sleeves_belly");
            case "0003_00_01":
                return LocalizationManager.Get("costume.tracksuit_shorts");
            case "0003_00_02":
                return LocalizationManager.Get("costume.tracksuit_bloomers");
            case "0003_01_01":
                return LocalizationManager.Get("costume.tracksuit_long_pants");
            case "0003_01_02":
                return LocalizationManager.Get("costume.tracksuit_rolled_up");
            case "0004_00_00":
                return LocalizationManager.Get("costume.swimsuit");
            case "0004_01_00":
                return LocalizationManager.Get("costume.towel");
            default:
