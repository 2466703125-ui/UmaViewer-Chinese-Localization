...
public class UISettingsSound : MonoBehaviour
{
    ...
    {
        TitleText.text = LocalizationManager.Get("ui.no_audio");
    ...
    public void ExportAudio()
    {
        ...
        if (LiveSources.Count > 0)
        {
            ...
            var path = StandaloneFileBrowser.SaveFilePanel(LocalizationManager.Get("audio.save_mp3"), Config.Instance.MainPath, $"{TitleText.text}", "mp3");
